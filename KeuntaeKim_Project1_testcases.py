from KeuntaeKim_Project1 import read_input_file, gcd_list, heuristic_score, create_successors, a_star_search
import numpy as np
import unittest

class KeuntaeKimProject1Testcases(unittest.TestCase):
